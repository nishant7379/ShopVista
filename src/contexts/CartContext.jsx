...
const CartProvider = ({ children }) => {
  ...
  return <CartContext.Provider value={{ cart, addToCart, removeFromCart, clearCart, increaseAmount, decreaseAmount, itemAmount, total, dot }}>{children}</CartContext.Provider>;
};
